...
const OrbitControls = ({board, selectedPoint, onSelectedPoint}, ref) => {
   ...
   return (
     <trackballControls ref={controls} args={[camera, gl.domElement]} dynamicDampingFactor={0.1} rotationLock={[
        true, // orbit
        true, // zoom
        true, // pan
     ]} mouseButtons={{
        ...
        RIGHT : MOUSE.ROTATE,
        MIDDLE: MOUSE.ZOOM,
     }} enabled={true} zoomSpeed={0.5} zoomFactor={0.1} panSpeed={0.1} rotateSpeed={0.15}
     />
   );
};
