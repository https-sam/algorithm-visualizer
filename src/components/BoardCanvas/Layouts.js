...
function interpolateSourceTarget(board, progress) {
  for (let i = 0; i < board.length; ++i) {
    board[i].x =
      (1 - progress) * board[i].sourceX + progress * board[i].targetX;
    board[i].y =
      (1 - progress) * board[i].sourceY + progress * board[i].targetY;
    board[i].z =
      (1 - progress) * board[i].sourceZ + progress * board[i].targetZ;
