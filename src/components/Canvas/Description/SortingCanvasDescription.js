...
function SortingCanvasDescription() {
  return (
    <div className="self-center max-w-[90vw] text-gray-700 dark:text-white mt-10 md:mt-0 md:pt-0 pb-[10em]">
      <p className="text-[1.5em] md:text-[2em] font-semibold mb-5">Welcome to Sorting Visualizer</p>
      <div>
      ...
      <div className="mt-[4em]">
        ...
        <li className="list-none mt-5 space-y-3">
          ...
          <ul className="space-x-2"><CPU className="mr-2 dark:stroke-textGray stroke-[#7B7B7c] scale-[1.2] inline "/><BoldParagraph text="Processing bars color"/><NormalParagraph text="Bars color"/></ul>
          <ul className="space-x-2"><Key className="mr-2 dark:stroke-textGray stroke-[#7B7B7c] scale-[1.2] inline "/><BoldParagraph text="Sorted"/><NormalParagraph text="Bars color"/> </ul>
          ...
          <ul className="space-x-2"><Runner className="mr-2 dark:stroke-textGray stroke-[#7B7B7c] scale-[1.2] inline "/><BoldParagraph text="Fsster"/><NormalParagraph text="animation (skips some animations)"/> </ul>
        </li>
      </div>
    </div>
  )
