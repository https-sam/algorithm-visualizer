...
function AlgorithmSelection({strategy, options}) {
  ...
  return (
    <div className="relative self-center">
      ...
      {/* Dropdown menu */}
      <div className={`transition-all duration-200 ease-in-out absolute h-[fit] w-[9.5em] text-[.95em] dark:bg-gray-600 bg-gray-500 top-[3.5em] rounded-md z-20 ${showDropdown ? "scale-100" : "scale-[0] -translate-y-[8em]"} `}>
