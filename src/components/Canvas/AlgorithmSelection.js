...
function AlgorithmSelection({ strategy, options }) {
  ...
  useEffect(() => {
    // SG 07/12/2022 11:12  setting initial strategy
  ...
  return (
    <div className="relative self-center">
      <div
        ...
        className="w-[9.5em] text-[.95em] h-[2.8em] dark:bg-gray-600 bg-gray-500 dark:hover:bg-gray-700 hover:bg-gray-600 rounded-md flex items-center justify-around cursor-pointer"
        onClick={() => setShowDropdown(!showDropdown)}
      >
        <p className="text-white font-semibold ml-2">{currentAlgo} Sort</p>
        <Triangle
          className={`h-5 transition-all duration-200 ease-in-out scale-[.5] ${
      ...
      {/* Dropdown menu */}
      <div
        className={`transition-all duration-200 ease-in-out absolute h-[fit] w-[9.5em] text-[.95em] dark:bg-gray-600 bg-gray-500 top-[3.9em] rounded-md z-20 ${
          showDropdown ? "scale-100" : "scale-[0] -translate-y-[8em]"
        } `}
      >
        <div
          className={`${
            currentAlgo === "Radix" && "bg-gray-200"
          } group cursor-pointer w-full dark:hover:bg-gray-700 hover:bg-gray-600 rounded-t-md font-semibold text-white h-[2.8em] flex items-center justify-start pl-4`}
          onClick={() => {
        ...
        >
          <p
            className={`${
              currentAlgo === "Radix" && "text-black group-hover:text-white"
            }`}
          >
            Radix Sort
          </p>
        ...
        <div
          className={`${
            currentAlgo === "Heap" && "bg-gray-200"
          } group cursor-pointer w-full hover:bg-gray-700 font-semibold text-white h-[2.8em] flex items-center justify-start pl-4`}
          onClick={() => {
            setCurrentAlgo("Heap");
        ...
        >
          <p
            className={`${
              currentAlgo === "Heap" && "text-black group-hover:text-white"
            }`}
          >
            Heap Sort
          </p>
        ...
        >
          <p
            className={`${
              currentAlgo === "Quick" && "text-black group-hover:text-white"
            }`}
          >
            Quick Sort
          </p>
        ...
        >
          <p
            className={`${
              currentAlgo === "Merge" && "text-black group-hover:text-white"
            }`}
          >
            Merge Sort
          </p>
        ...
        >
          <p
            className={`${
              currentAlgo === "Shell" && "text-black group-hover:text-white"
            }`}
          >
            Shell Sort
          </p>
        ...
        <div
          className={`${
            currentAlgo === "Selection" && "bg-gray-200"
          } group cursor-pointer w-full rounded-b-md  hover:bg-gray-700 font-semibold text-white h-[2.8em] flex items-center justify-start pl-4`}
          onClick={() => {
        ...
        >
          <p
            className={`${
              currentAlgo === "Selection" && "text-black group-hover:text-white"
            }`}
          >
            Selection Sort
          </p>
