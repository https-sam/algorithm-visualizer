      ...
      <div className="rounded-md z-10">
        ...
        <div className="w-fit flex space-x-5">
          ...
          <div className="flex flex-col items-center relative space-y-2 cursor-pointer">
            ...
            <p className={`bg-white z-10 inline absolute top-[100%] p-1 rounded-md hidden peer-hover:block tool-tip-options text-gray-600`}><span className="font-bold">Unsorted</span> bars color</p>
          </div>
          ...
          <div className="flex flex-col items-center relative space-y-2 cursor-pointer">
            ...
            <p className={`bg-white inline z-10 absolute top-[100%] p-1 rounded-md hidden peer-hover:block tool-tip-options text-gray-600`}><span className="font-bold">Sorted</span> bars color</p>
          </div>
          ...
          <div className="flex flex-col items-center relative space-y-2 cursor-pointer">
            ...
            <p className={`bg-white inline z-10 absolute top-[100%] p-1 rounded-md hidden peer-hover:block tool-tip-options text-gray-600`}><span className="font-bold">Processing</span> bars color</p>
          </div>
          ...
          <div className={`${algorithm === 'Selection' ? 'block' : 'hidden'} flex flex-col items-center relative space-y-2 cursor-pointer`}>
            ...
            <p className={`bg-white inline z-10 absolute top-[100%] p-1 rounded-md hidden peer-hover:block tool-tip-options text-gray-600`}>Current<span className="font-bold ml-1">optimum</span> bar color</p>
          </div>
          ...
          <div className="flex flex-col items-center relative space-y-2 cursor-pointer">
            ...
            <p className={`bg-white inline z-10 absolute top-[100%] p-1 rounded-md hidden peer-hover:block tool-tip-options text-gray-600`}>Animation <span className="font-bold">Delay</span></p>
          </div>
          ...
          <div className={`${(algorithm === 'Selection' || algorithm === 'Radix') ? 'block' : 'hidden'} flex flex-col items-center relative space-y-2 cursor-pointer`}>
            ...
            <p className={`bg-white inline z-10 absolute top-[100%] p-1 rounded-md hidden peer-hover:block tool-tip-options text-gray-600`}><span className="font-bold">Faster</span> Animation</p>
          </div>       
